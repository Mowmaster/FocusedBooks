...
public class ItemEnchantableBookPedestalsMagnet extends ItemEnchantableBook implements IMagnetBook {
    ...
    public ItemEnchantableBookPedestalsMagnet(Item sudoItem, String enchantName, EnchantmentType category, int color, IItemProvider ingredient, boolean doesWork) {
