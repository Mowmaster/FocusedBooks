...
public class ItemEnchantableBook extends BookItem {
    ...
    * Removed as although it 'fixes' the issue, it also allows any enchant to be applied (for shields)
    ...
    public static final Item PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:protection",EnchantmentType.ARMOR, 16755455, Items.LEATHER, true ).setRegistryName(new ResourceLocation(MODID, "book_protection"));//Leather
    public static final Item FIRE_PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:fire_protection",EnchantmentType.ARMOR, 85,  Items.MAGMA_CREAM, true ).setRegistryName(new ResourceLocation(MODID, "book_fireprotection"));//magma_cream
    public static final Item FEATHER = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:feather_falling",EnchantmentType.ARMOR_FEET, 170,  Items.FEATHER, true ).setRegistryName(new ResourceLocation(MODID, "book_featherfall"));//feather
    public static final Item BLAST_PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:blast_protection",EnchantmentType.ARMOR, 255,  Items.GUNPOWDER, true ).setRegistryName(new ResourceLocation(MODID, "book_blastprotection"));//gunpowder
    public static final Item PROJ_PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:projectile_protection",EnchantmentType.ARMOR, 21760,  Items.ARROW, true ).setRegistryName(new ResourceLocation(MODID, "book_projectileprotection"));//arrow
    public static final Item BREATHE = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:respiration",EnchantmentType.ARMOR_HEAD, 21845,  Items.PUFFERFISH, true ).setRegistryName(new ResourceLocation(MODID, "book_respiration"));//pufferfish
    public static final Item WATER_WORKER = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:aqua_affinity",EnchantmentType.ARMOR_HEAD, 21930,  Items.SALMON, true ).setRegistryName(new ResourceLocation(MODID, "book_aquaaffinity"));//salmon
    public static final Item THORNY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"minecraft:thorns",EnchantmentType.ARMOR_CHEST, 22015,  Items.SWEET_BERRIES, true ).setRegistryName(new ResourceLocation(MODID, "book_thorns"));//sweat_berries
    public static final Item WATER_JESUS = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:depth_strider",EnchantmentType.ARMOR_FEET, 43520,  Items.SCUTE, true ).setRegistryName(new ResourceLocation(MODID, "book_depthstrider"));//scute
    public static final Item FROSTY_JESUS = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:frost_walker",EnchantmentType.ARMOR_FEET, 43605,  Blocks.BLUE_ICE, true ).setRegistryName(new ResourceLocation(MODID, "book_frostwalker"));//blue_ice
    public static final Item SOUL_JESUS = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:soul_speed",EnchantmentType.ARMOR_FEET, 43690,  Blocks.SOUL_SOIL, true ).setRegistryName(new ResourceLocation(MODID, "book_soulspeed"));//soul_soil
    public static final Item SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:sharpness",EnchantmentType.WEAPON, 43775,  Blocks.GRINDSTONE, true ).setRegistryName(new ResourceLocation(MODID, "book_sharpness"));//grindstone
    public static final Item DEAD_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:smite",EnchantmentType.WEAPON, 65280,  Items.ROTTEN_FLESH, true ).setRegistryName(new ResourceLocation(MODID, "book_smite"));//rotten_flesh
    public static final Item SPIDER_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:bane_of_arthropods",EnchantmentType.WEAPON, 65365,  Items.SPIDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_baneofawfulturds"));//spider_eye
    public static final Item FIRE_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:fire_aspect",EnchantmentType.WEAPON, 65450,  Items.FLINT_AND_STEEL, true ).setRegistryName(new ResourceLocation(MODID, "book_fireaspect"));//flint_and_steel
    public static final Item SWEEP_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:sweeping",EnchantmentType.WEAPON, 65535,  Blocks.HAY_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_sweeping"));//hay_block
    public static final Item PUSHY = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:knockback",EnchantmentType.WEAPON, 5570560,  Blocks.PISTON, true ).setRegistryName(new ResourceLocation(MODID, "book_knockback"));//piston
    public static final Item LOOTER = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:looting",EnchantmentType.WEAPON, 5570645,  Items.NETHERITE_SCRAP, true ).setRegistryName(new ResourceLocation(MODID, "book_looting"));//netherite_scrap
    public static final Item FAST_DIG = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:efficiency",EnchantmentType.DIGGER, 5570730,  Items.SUGAR, true ).setRegistryName(new ResourceLocation(MODID, "book_efficiency"));//sugar
    public static final Item SILK_DIG = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:silk_touch",EnchantmentType.DIGGER, 5570815,  Blocks.SPONGE, true ).setRegistryName(new ResourceLocation(MODID, "book_silktouch"));//sponge
    public static final Item FORT_DIG = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:fortune",EnchantmentType.DIGGER, 5592320,  Blocks.ANCIENT_DEBRIS, true ).setRegistryName(new ResourceLocation(MODID, "book_fortune"));//ancient_debris
    public static final Item UNBREAK = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:unbreaking",EnchantmentType.DIGGER, 5592405,  Blocks.IRON_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_unbreaking"));//iron_block
    public static final Item POWER_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:power",EnchantmentType.BOW, 5592490,  Items.BLAZE_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_power"));//blaze_rod
    public static final Item PUSHY_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:punch",EnchantmentType.BOW, 5592575,  Blocks.STICKY_PISTON, true ).setRegistryName(new ResourceLocation(MODID, "book_punch"));//sticky_piston
    public static final Item FIREY_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:flame",EnchantmentType.BOW, 5614080,  Items.FIRE_CHARGE, true ).setRegistryName(new ResourceLocation(MODID, "book_flame"));//fire_charge
    public static final Item UNLIM_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:infinity",EnchantmentType.BOW, 5614165,  Blocks.END_STONE, true ).setRegistryName(new ResourceLocation(MODID, "book_infinity"));//end_stone
    public static final Item LUCKY_PHISH = new ItemEnchantableBook(Items.FISHING_ROD,"minecraft:luck_of_the_sea",EnchantmentType.FISHING_ROD, 5614250,  Blocks.LAPIS_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_luckofthesea"));//lapis_block
    public static final Item SPEEDY_PHISH = new ItemEnchantableBook(Items.FISHING_ROD,"minecraft:lure",EnchantmentType.FISHING_ROD, 5614335,  Blocks.COMPOSTER, true ).setRegistryName(new ResourceLocation(MODID, "book_lure"));//composter
    public static final Item LOYAL_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:loyalty",EnchantmentType.TRIDENT, 5635840,  Items.BONE, true ).setRegistryName(new ResourceLocation(MODID, "book_loyality"));//bone
    public static final Item STABBY_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:impaling",EnchantmentType.TRIDENT, 5635925,  Items.BAMBOO, true ).setRegistryName(new ResourceLocation(MODID, "book_impaling"));//bamboo
    public static final Item WATERY_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:riptide",EnchantmentType.TRIDENT, 5636010,  Blocks.PRISMARINE, true ).setRegistryName(new ResourceLocation(MODID, "book_riptide"));//prismarine
    public static final Item LIT_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:channeling",EnchantmentType.TRIDENT, 5636095,  Blocks.END_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_channeling"));//end_rod
    public static final Item MULTI_CROSS = new ItemEnchantableBook(Items.CROSSBOW,"minecraft:multishot",EnchantmentType.CROSSBOW, 11141120,  Items.GHAST_TEAR, true ).setRegistryName(new ResourceLocation(MODID, "book_multishot"));//ghast_tear
    public static final Item QUICK_CROSS = new ItemEnchantableBook(Items.CROSSBOW,"minecraft:quick_charge",EnchantmentType.CROSSBOW, 11141205,  Items.FIREWORK_STAR, true ).setRegistryName(new ResourceLocation(MODID, "book_quickcharge"));//firework_star
    public static final Item STABBY_CROSS = new ItemEnchantableBook(Items.CROSSBOW,"minecraft:piercing",EnchantmentType.CROSSBOW, 11141290,  Items.FIREWORK_ROCKET, true ).setRegistryName(new ResourceLocation(MODID, "book_piercing"));////firework_rocket
    public static final Item FIXERUPPER = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:mending",EnchantmentType.DIGGER, 11141375,  Items.NETHER_STAR, true ).setRegistryName(new ResourceLocation(MODID, "book_mending"));//nether_star
    public static final Item BOUND_CURSE = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:binding_curse",EnchantmentType.ARMOR, 11162880,  Blocks.CHAIN, true ).setRegistryName(new ResourceLocation(MODID, "book_bindingcurse"));//chain
    public static final Item VANISH_CURSE = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:vanishing_curse",EnchantmentType.ARMOR, 11162965,  Items.FERMENTED_SPIDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_vanishingcurse"));//fermented_spider_eye

    public static final Item APOTH_BANE = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:bane_of_illagers",EnchantmentType.WEAPON, 11163050,  Items.EMERALD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothbaneofillagers"));
    public static final Item APOTH_CRAZY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:berserk",EnchantmentType.ARMOR, 11163135,  Items.BLAZE_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothberserk"));
    ...
    public static final Item APOTH_CRESCENDO = new ItemEnchantableBook(Items.CROSSBOW,"apotheosis:crescendo",EnchantmentType.CROSSBOW, 11184725,  Items.ARROW, true ).setRegistryName(new ResourceLocation(MODID, "book_apothcrescendo"));
    public static final Item APOTH_MINER = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"apotheosis:depth_miner",EnchantmentType.DIGGER, 11184810,  Blocks.OBSIDIAN, true ).setRegistryName(new ResourceLocation(MODID, "book_apothdepthminer"));
    public static final Item APOTH_HELLINFUSION = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:hell_infusion",EnchantmentType.WEAPON, 11184895,  Blocks.NETHERRACK, true ).setRegistryName(new ResourceLocation(MODID, "book_apothhellinfusion"));
    public static final Item APOTH_COLDPOKEY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:icy_thorns",EnchantmentType.ARMOR_CHEST, 11206400,  Items.SWEET_BERRIES, true ).setRegistryName(new ResourceLocation(MODID, "book_apothicythorns"));
    public static final Item APOTH_KNOWITALL = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:knowledge",EnchantmentType.WEAPON, 11206485,  Items.EXPERIENCE_BOTTLE, true ).setRegistryName(new ResourceLocation(MODID, "book_apothknowledge"));
    public static final Item APOTH_VAMPIRE = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:life_mending",EnchantmentType.BREAKABLE, 11206570,  Items.WITHER_SKELETON_SKULL, true ).setRegistryName(new ResourceLocation(MODID, "book_apothlifemending"));
    public static final Item APOTH_WITCHY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:magic_protection",EnchantmentType.ARMOR, 11206655,  Items.POTION, true ).setRegistryName(new ResourceLocation(MODID, "book_apothmagicprotection"));
    public static final Item APOTH_DRYAD = new ItemEnchantableBook(Items.DIAMOND_HOE,"apotheosis:natures_blessing",EnchantmentType.DIGGER, 16711680,  Blocks.VINE, true ).setRegistryName(new ResourceLocation(MODID, "book_apothnaturesblessing"));
    public static final Item APOTH_BYEBYE = new ItemEnchantableBook(Items.ANVIL,"apotheosis:obliteration",EnchantmentType.BREAKABLE, 16711765,  Items.LAVA_BUCKET, true ).setRegistryName(new ResourceLocation(MODID, "book_apothobliteration"));
    public static final Item APOTH_BOING = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:rebounding",EnchantmentType.ARMOR, 16711850,  Items.SLIME_BALL, true ).setRegistryName(new ResourceLocation(MODID, "book_apothrebounding"));
    public static final Item APOTH_CHING = new ItemEnchantableBook(Items.SHIELD,"apotheosis:reflective",EnchantmentType.BREAKABLE, 16711935,  Blocks.GLASS, true ).setRegistryName(new ResourceLocation(MODID, "book_apothreflective"));
    public static final Item APOTH_SCAV = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:scavenger",EnchantmentType.WEAPON, 16733440,  Items.WHEAT_SEEDS, true ).setRegistryName(new ResourceLocation(MODID, "book_apothscavenger"));
    public static final Item APOTH_SEAINFUSION = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:sea_infusion",EnchantmentType.WEAPON, 16733525,  Items.PRISMARINE_SHARD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothseainfusion"));
    public static final Item APOTH_CABAL = new ItemEnchantableBook(Items.SHIELD,"apotheosis:shield_bash",EnchantmentType.BREAKABLE, 16733610,  Items.SHIELD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothshieldbash"));
    public static final Item APOTH_SPLITS = new ItemEnchantableBook(Items.ANVIL,"apotheosis:splitting",EnchantmentType.BREAKABLE, 16733695,  Blocks.ANVIL, true ).setRegistryName(new ResourceLocation(MODID, "book_apothsplitting"));
    public static final Item APOTH_FOOTY = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"apotheosis:stable_footing",EnchantmentType.ARMOR_FEET, 16755200,  Items.GOLDEN_BOOTS, true ).setRegistryName(new ResourceLocation(MODID, "book_apothstablefooting"));
    public static final Item APOTH_SINNER = new ItemEnchantableBook(Items.DIAMOND_HOE,"apotheosis:tempting",EnchantmentType.DIGGER, 16755285,  Items.WHEAT, true ).setRegistryName(new ResourceLocation(MODID, "book_apothtempting"));
    public static final Item APOTH_NEVERENDING = new ItemEnchantableBook(Items.BOW,"apotheosis:true_infinity",EnchantmentType.BOW, 16755370,  Blocks.END_STONE, true ).setRegistryName(new ResourceLocation(MODID, "book_apothtrueinfinity"));
    ...
    public static final Item ALEXSMOBS_BRETURN = new ItemEnchantableBook(Items.BOOK,"alexsmobs:board_return",STRADDLEBOARD, 16755370,  Items.ENDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_alexsboardreturn"));
    public static final Item ALEXSMOBS_LAVAWAX = new ItemEnchantableBook(Items.BOOK,"alexsmobs:lavawax",STRADDLEBOARD, 16755370,  Items.HONEYCOMB, true ).setRegistryName(new ResourceLocation(MODID, "book_alexslavawax"));
    public static final Item ALEXSMOBS_SERPENT = new ItemEnchantableBook(Items.BOOK,"alexsmobs:serpentfriend",STRADDLEBOARD, 16755370,  Items.INK_SAC, true ).setRegistryName(new ResourceLocation(MODID, "book_alexsserpentfriend"));
    public static final Item ALEXSMOBS_SJUMP = new ItemEnchantableBook(Items.BOOK,"alexsmobs:straddle_jump",STRADDLEBOARD, 16755370,  Items.RABBIT_FOOT, true ).setRegistryName(new ResourceLocation(MODID, "book_alexsstraddlejump"));

    public static final Item ARSN_BOOST = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ars_nouveau:mana_boost",EnchantmentType.ARMOR, 16755370,  Items.BLAZE_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_arsnmanaboost"));
    public static final Item ARSN_REGEN = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ars_nouveau:mana_regen",EnchantmentType.ARMOR, 16755370,  Items.GHAST_TEAR, true ).setRegistryName(new ResourceLocation(MODID, "book_arsnmanaregen"));
    public static final Item ARSN_REACTIVE = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ars_nouveau:reactive",EnchantmentType.WEARABLE, 16755370,  Items.GUNPOWDER, false ).setRegistryName(new ResourceLocation(MODID, "book_arsnreactive"));

    public static final Item ASTRAL_VISION = new ItemEnchantableBook(Items.DIAMOND_HELMET,"astralsorcery:night_vision",EnchantmentType.ARMOR_HEAD, 16755370,  Items.GOLDEN_CARROT, false ).setRegistryName(new ResourceLocation(MODID, "book_astralnightvision"));
    public static final Item ASTRAL_SCORCH = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"astralsorcery:scorching_heat",EnchantmentType.DIGGER, 16755370, Blocks.BLAST_FURNACE, true ).setRegistryName(new ResourceLocation(MODID, "book_astralscorchingheat"));

    public static final Item BETTERENDFORGE_VEIL = new ItemEnchantableBook(Items.DIAMOND_HELMET,"betterendforge:end_veil",EnchantmentType.ARMOR_HEAD, 16755370,  Blocks.CHORUS_FLOWER, true ).setRegistryName(new ResourceLocation(MODID, "book_befendveil"));
    ...
    public static final Item ENSORCELL_AIRAFF = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:air_affinity",EnchantmentType.ARMOR_HEAD, 16755370,  Items.FEATHER, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationairaffinity"));
    public static final Item ENSORCELL_ANGLER = new ItemEnchantableBook(Items.FISHING_ROD,"ensorcellation:angler",EnchantmentType.FISHING_ROD, 16755370,  Items.TROPICAL_FISH, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationangler"));
    public static final Item ENSORCELL_BULWARK = new ItemEnchantableBook(Items.SHIELD,"ensorcellation:bulwark",EnchantmentType.BREAKABLE, 16755370,  Items.SHIELD, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationbulwark"));
    ...
    public static final Item ENSORCELL_CFOOL = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:curse_fool",EnchantmentType.ARMOR_HEAD, 16755370,  Items.GOLDEN_SWORD, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationcursefool"));
    ...
    public static final Item ENSORCELL_DAMENDER = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:damage_ender",SWORD_OR_AXE, 16755370,  Items.ENDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationdamageender"));
    public static final Item ENSORCELL_DAMILLAG = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:damage_illager",SWORD_OR_AXE, 16755370,  Items.IRON_AXE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationdamageillager"));
    public static final Item ENSORCELL_DAMVILLA = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:damage_villager",SWORD_OR_AXE_OR_CROSSBOW, 16755370,  Items.EMERALD, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationdamagevillager"));
    //Cant get to work for some reason :shrug:
    public static final Item ENSORCELL_DISPLACE = new ItemEnchantableBook(Items.SHIELD,"ensorcellation:displacement",EnchantmentType.ARMOR_CHEST, 16755370,  Items.BUCKET, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationdisplacement"));
    public static final Item ENSORCELL_EXCAV = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"ensorcellation:excavating",PICKAXE_OR_SHOVEL, 16755370,  Items.IRON_PICKAXE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationexcavating"));
    public static final Item ENSORCELL_XPBOOST = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:exp_boost",EnchantmentType.ARMOR_HEAD, 16755370,  Items.EXPERIENCE_BOTTLE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationexpboost"));
    public static final Item ENSORCELL_FIREREBU = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:fire_rebuke",EnchantmentType.ARMOR_CHEST, 16755370,  Items.FIRE_CHARGE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationfirerebuke"));
    public static final Item ENSORCELL_FROSTASP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:frost_aspect",SWORD_OR_AXE, 16755370,  Items.SNOWBALL, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationfrostaspect"));
    public static final Item ENSORCELL_FURROW = new ItemEnchantableBook(Items.DIAMOND_HOE,"ensorcellation:furrowing",HOE, 16755370,  Blocks.GRASS_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationfurrowing"));
    public static final Item ENSORCELL_GOURMAND = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:gourmand",EnchantmentType.ARMOR_HEAD, 16755370,  Items.RABBIT_STEW, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationgourmand"));
    public static final Item ENSORCELL_HUNTER = new ItemEnchantableBook(Items.BOW,"ensorcellation:hunter",EnchantmentType.BOW, 16755370,  Items.ARROW, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationhunter"));
    public static final Item ENSORCELL_INSTIG = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:instigating",SWORD_OR_AXE, 16755370,  Items.ENDER_PEARL, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationinstigating"));
    public static final Item ENSORCELL_LEECH = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:leech",SWORD_OR_AXE, 16755370,  Items.SPIDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationleech"));
    public static final Item ENSORCELL_MAGEDGE = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:magic_edge",SWORD_OR_AXE, 16755370,  Items.GLOWSTONE_DUST, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationmagicedge"));
    public static final Item ENSORCELL_MAGPROT = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:magic_protection",EnchantmentType.ARMOR, 16755370,  Items.GLASS_BOTTLE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationmagicprotection"));
    public static final Item ENSORCELL_PHALANX = new ItemEnchantableBook(Items.SHIELD,"ensorcellation:phalanx",EnchantmentType.BREAKABLE, 16755370,  Items.WHITE_BANNER, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationphalanx"));
    public static final Item ENSORCELL_PILF = new ItemEnchantableBook(Items.FISHING_ROD,"ensorcellation:pilfering",EnchantmentType.FISHING_ROD, 16755370,  Items.DIAMOND, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationpilfering"));
    public static final Item ENSORCELL_QUICKD = new ItemEnchantableBook(Items.BOW,"ensorcellation:quick_draw",EnchantmentType.BOW, 16755370,  Items.BOW, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationquickdraw"));
    public static final Item ENSORCELL_REACH = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:reach",EnchantmentType.ARMOR_CHEST, 16755370,  Blocks.PISTON, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationreach"));
    public static final Item ENSORCELL_SOULB = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:soulbound",ENCHANTABLE, 16755370,  Items.NETHER_STAR, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationsoulbound"));
    public static final Item ENSORCELL_TILL = new ItemEnchantableBook(Items.DIAMOND_HOE,"ensorcellation:tilling",HOE, 16755370,  Items.GOLDEN_HOE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationtilling"));
    ...
    public static final Item ENSORCELL_VITALITY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:vitality",EnchantmentType.ARMOR_CHEST, 16755370,  Items.POTION, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationvitality"));
    ...
    public static final Item ENSORCELL_VORPAL = new ItemEnchantableBook(Items.DIAMOND_SWORD,"ensorcellation:vorpal",SWORD_OR_AXE, 16755370,  Items.GOLDEN_SWORD, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationvorpal"));
    public static final Item ENSORCELL_WEEDS = new ItemEnchantableBook(Items.DIAMOND_HOE,"ensorcellation:weeding",HOE, 16755370,  Items.SHEARS, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationweeding"));

    public static EnchantmentType KNIFE = EnchantmentType.create("knife", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    public static final Item FARMERS_BSTAB = new ItemEnchantableBook(Items.BOOK,"farmersdelight:backstabbing",KNIFE, 16755370,  Items.IRON_SWORD, true ).setRegistryName(new ResourceLocation(MODID, "book_farmersbackstabbing"));
    ...
    public static final Item GUNS_BULL = new ItemEnchantableBook(Items.BOOK,"gunswithoutroses:bullseye",GWR_GUN, 16755370,  Blocks.TARGET, true ).setRegistryName(new ResourceLocation(MODID, "book_gunsbullseye"));
    public static final Item GUNS_IMPACT = new ItemEnchantableBook(Items.BOOK,"gunswithoutroses:impact",GWR_GUN, 16755370,  Blocks.TNT, true ).setRegistryName(new ResourceLocation(MODID, "book_gunsimpact"));
    public static final Item GUNS_PRESRV = new ItemEnchantableBook(Items.BOOK,"gunswithoutroses:preserving",GWR_GUN, 16755370,  Blocks.ICE, true ).setRegistryName(new ResourceLocation(MODID, "book_gunspreserving"));
    public static final Item GUNS_SLEIGHT = new ItemEnchantableBook(Items.BOOK,"gunswithoutroses:sleight_of_hand",GWR_GUN, 16755370, Items.EMERALD, true ).setRegistryName(new ResourceLocation(MODID, "book_gunssleightofhand"));

    public static final Item MVL_REPAIR = new ItemEnchantableBook(Items.BOW,"morevanillalib:repairing_luck",EnchantmentType.BREAKABLE, 16755370,  Items.RABBIT_FOOT, true ).setRegistryName(new ResourceLocation(MODID, "book_mvlrepairingluck"));
    ...
    public static final Item MYTHICB_HAMMA = new ItemEnchantableBook(Items.BOOK,"mythicbotany:hammer_mobility",HAMMA, 16755370,  Items.NETHERITE_PICKAXE, true ).setRegistryName(new ResourceLocation(MODID, "book_mythicbhammermobility"));

    public static final Item NATURES_MEND = new ItemEnchantableBook(Items.BOW,"naturesaura:aura_mending",EnchantmentType.BREAKABLE, 16755370,  Blocks.OAK_LEAVES, true ).setRegistryName(new ResourceLocation(MODID, "book_naturesauramending"));
    ...
    public static final Item PEDESTALS_ADVANCED = new ItemEnchantableBook(Items.BOOK,"pedestals:upgradeadvanced",PEDESTALS, 16755370,  Items.NETHER_STAR, false ).setRegistryName(new ResourceLocation(MODID, "book_pedestalsupgradeadvanced"));
    public static final Item PEDESTALS_AREA = new ItemEnchantableBook(Items.BOOK,"pedestals:upgradearea",PEDESTALS, 16755370,  Items.IRON_INGOT, false ).setRegistryName(new ResourceLocation(MODID, "book_pedestalsupgradearea"));
    public static final Item PEDESTALS_CAP = new ItemEnchantableBook(Items.BOOK,"pedestals:upgradecapacity",PEDESTALS, 16755370,  Items.EMERALD, false ).setRegistryName(new ResourceLocation(MODID, "book_pedestalsupgradecapacity"));
    public static final Item PEDESTALS_MAGNET = new ItemEnchantableBook(Items.BOOK,"pedestals:upgrademagnet",PEDESTALS, 16755370,  Blocks.HOPPER, false ).setRegistryName(new ResourceLocation(MODID, "book_pedestalsupgrademagnet"));
    public static final Item PEDESTALS_RANGE = new ItemEnchantableBook(Items.BOOK,"pedestals:upgraderange",PEDESTALS, 16755370,  Items.GOLD_INGOT, false ).setRegistryName(new ResourceLocation(MODID, "book_pedestalsupgraderange"));
    public static final Item PEDESTALS_SPEED = new ItemEnchantableBook(Items.BOOK,"pedestals:upgradespeed",PEDESTALS, 16755370,  Items.DIAMOND, false ).setRegistryName(new ResourceLocation(MODID, "book_pedestalsupgradespeed"));
