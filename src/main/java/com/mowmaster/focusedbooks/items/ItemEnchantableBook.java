...
public class ItemEnchantableBook extends BookItem {
    ...
    final ItemLike getIngredient;
    final int getColor;
    final boolean works;

    public ItemEnchantableBook(Item sudoItem, String enchantName, EnchantmentCategory category, int color, ItemLike ingredient,boolean doesWork) {
    ...
    public ItemLike getGetIngredient()
    {
    ...
    public EnchantmentCategory getEnchantType()
    {
        return type;
    }
    ...
    * Removed as although it 'fixes' the issue, it also allows any enchant to be applied (for shields)
    ...
    public void inventoryTick(ItemStack p_77663_1_, Level p_77663_2_, Entity p_77663_3_, int p_77663_4_, boolean p_77663_5_) {
        ...
        if(p_77663_1_.isEnchanted())
        {
            ...
            if(p_77663_3_ instanceof Player)
            {
                ...
                int slot = player.getInventory().findSlotMatchingItem(p_77663_1_);
                p_77663_1_.shrink(1);
                ItemHandlerHelper.giveItemToPlayer(player,newBook,slot);
            }
        }
    }
    ...
    @Override
    public void appendHoverText(ItemStack p_77624_1_, @Nullable Level p_77624_2_, List<Component> p_41423_, TooltipFlag p_41424_) {
        super.appendHoverText(p_77624_1_, p_77624_2_, p_41423_, p_41424_);
        if(p_77624_1_.getItem() instanceof ItemEnchantableBook)
        {
            ...
            if(works)
            {
                ...
                {
                    TranslatableComponent minNeeded = new TranslatableComponent( MODID + ".minNeeded");
                    minNeeded.withStyle(ChatFormatting.WHITE);
                    minNeeded.append(""+ench.getMinCost(ench.getMinLevel())+"");
                    minNeeded.withStyle(ChatFormatting.GREEN);
                    p_41423_.add(minNeeded);

                    TranslatableComponent maxNeeded = new TranslatableComponent( MODID + ".maxNeeded");
                    maxNeeded.withStyle(ChatFormatting.WHITE);
                    maxNeeded.append(""+ench.getMaxCost(ench.getMaxLevel())+"");
                    maxNeeded.withStyle(ChatFormatting.BLUE);
                    p_41423_.add(maxNeeded);

                    if(ench.isTreasureOnly())
                    {
                        //toString() is the new translationKey() (item reg name)
                        TranslatableComponent isTreasure = new TranslatableComponent( MODID + ".isTreasure");
                        isTreasure.withStyle(ChatFormatting.RED);
                        p_41423_.add(isTreasure);
                    }

                    if(!ench.canApplyAtEnchantingTable(itemBook.getSudoItemStack()))
                    {
                        //toString() is the new translationKey() (item reg name)
                        TranslatableComponent cantEnchantTable = new TranslatableComponent( MODID + ".cantEnchantTable");
                        cantEnchantTable.withStyle(ChatFormatting.YELLOW);
                        p_41423_.add(cantEnchantTable);
                    }
                }
                else
                {
                    TranslatableComponent notOnBooks = new TranslatableComponent( MODID + ".notOnBooks");
                    notOnBooks.withStyle(ChatFormatting.RED);
                    p_41423_.add(notOnBooks);
                }
            }
            else
            {
                TranslatableComponent disabled = new TranslatableComponent( MODID + ".disabled");
                disabled.withStyle(ChatFormatting.RED);
                p_41423_.add(disabled);
            }
        }
    ...
    public static final Item PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:protection",EnchantmentCategory.ARMOR, 11206655, Items.LEATHER, true ).setRegistryName(new ResourceLocation(MODID, "book_protection"));//Leather
    public static final Item FIRE_PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:fire_protection",EnchantmentCategory.ARMOR, 16733440,  Items.MAGMA_CREAM, true ).setRegistryName(new ResourceLocation(MODID, "book_fireprotection"));//magma_cream
    public static final Item FEATHER = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:feather_falling",EnchantmentCategory.ARMOR_FEET, 16777215,  Items.FEATHER, true ).setRegistryName(new ResourceLocation(MODID, "book_featherfall"));//feather
    public static final Item BLAST_PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:blast_protection",EnchantmentCategory.ARMOR, 16755200,  Items.GUNPOWDER, true ).setRegistryName(new ResourceLocation(MODID, "book_blastprotection"));//gunpowder
    public static final Item PROJ_PROT = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:projectile_protection",EnchantmentCategory.ARMOR, 11184810,  Items.ARROW, true ).setRegistryName(new ResourceLocation(MODID, "book_projectileprotection"));//arrow
    public static final Item BREATHE = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:respiration",EnchantmentCategory.ARMOR_HEAD, 65535,  Items.PUFFERFISH, true ).setRegistryName(new ResourceLocation(MODID, "book_respiration"));//pufferfish
    public static final Item WATER_WORKER = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:aqua_affinity",EnchantmentCategory.ARMOR_HEAD, 5636095,  Items.SALMON, true ).setRegistryName(new ResourceLocation(MODID, "book_aquaaffinity"));//salmon
    public static final Item THORNY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"minecraft:thorns",EnchantmentCategory.ARMOR_CHEST, 21760,  Items.SWEET_BERRIES, true ).setRegistryName(new ResourceLocation(MODID, "book_thorns"));//sweat_berries
    public static final Item WATER_JESUS = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:depth_strider",EnchantmentCategory.ARMOR_FEET, 22015,  Items.SCUTE, true ).setRegistryName(new ResourceLocation(MODID, "book_depthstrider"));//scute
    public static final Item FROSTY_JESUS = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:frost_walker",EnchantmentCategory.ARMOR_FEET, 43775,  Blocks.BLUE_ICE, true ).setRegistryName(new ResourceLocation(MODID, "book_frostwalker"));//blue_ice
    public static final Item SOUL_JESUS = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"minecraft:soul_speed",EnchantmentCategory.ARMOR_FEET, 5570560,  Blocks.SOUL_SOIL, true ).setRegistryName(new ResourceLocation(MODID, "book_soulspeed"));//soul_soil
    public static final Item SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:sharpness",EnchantmentCategory.WEAPON, 16733525,  Blocks.GRINDSTONE, true ).setRegistryName(new ResourceLocation(MODID, "book_sharpness"));//grindstone
    public static final Item DEAD_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:smite",EnchantmentCategory.WEAPON, 11162965,  Items.ROTTEN_FLESH, true ).setRegistryName(new ResourceLocation(MODID, "book_smite"));//rotten_flesh
    public static final Item SPIDER_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:bane_of_arthropods",EnchantmentCategory.WEAPON, 11163050,  Items.SPIDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_baneofawfulturds"));//spider_eye
    public static final Item FIRE_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:fire_aspect",EnchantmentCategory.WEAPON, 16733440,  Items.FLINT_AND_STEEL, true ).setRegistryName(new ResourceLocation(MODID, "book_fireaspect"));//flint_and_steel
    public static final Item SWEEP_SHARP = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:sweeping",EnchantmentCategory.WEAPON, 11184810,  Blocks.HAY_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_sweeping"));//hay_block
    public static final Item PUSHY = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:knockback",EnchantmentCategory.WEAPON, 11206485,  Blocks.PISTON, true ).setRegistryName(new ResourceLocation(MODID, "book_knockback"));//piston
    public static final Item LOOTER = new ItemEnchantableBook(Items.DIAMOND_SWORD,"minecraft:looting",EnchantmentCategory.WEAPON, 16776960,  Items.NETHERITE_SCRAP, true ).setRegistryName(new ResourceLocation(MODID, "book_looting"));//netherite_scrap
    public static final Item FAST_DIG = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:efficiency",EnchantmentCategory.DIGGER, 16755200,  Items.SUGAR, true ).setRegistryName(new ResourceLocation(MODID, "book_efficiency"));//sugar
    public static final Item SILK_DIG = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:silk_touch",EnchantmentCategory.DIGGER, 16777215,  Blocks.SPONGE, true ).setRegistryName(new ResourceLocation(MODID, "book_silktouch"));//sponge
    public static final Item FORT_DIG = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:fortune",EnchantmentCategory.DIGGER, 16776960,  Blocks.ANCIENT_DEBRIS, true ).setRegistryName(new ResourceLocation(MODID, "book_fortune"));//ancient_debris
    public static final Item UNBREAK = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:unbreaking",EnchantmentCategory.DIGGER, 16777215,  Blocks.IRON_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_unbreaking"));//iron_block
    public static final Item POWER_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:power",EnchantmentCategory.BOW, 16733525,  Items.BLAZE_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_power"));//blaze_rod
    public static final Item PUSHY_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:punch",EnchantmentCategory.BOW, 11206485,  Blocks.STICKY_PISTON, true ).setRegistryName(new ResourceLocation(MODID, "book_punch"));//sticky_piston
    public static final Item FIREY_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:flame",EnchantmentCategory.BOW, 16733440,  Items.FIRE_CHARGE, true ).setRegistryName(new ResourceLocation(MODID, "book_flame"));//fire_charge
    public static final Item UNLIM_ARROW = new ItemEnchantableBook(Items.BOW,"minecraft:infinity",EnchantmentCategory.BOW, 16777215,  Blocks.END_STONE, true ).setRegistryName(new ResourceLocation(MODID, "book_infinity"));//end_stone
    public static final Item LUCKY_PHISH = new ItemEnchantableBook(Items.FISHING_ROD,"minecraft:luck_of_the_sea",EnchantmentCategory.FISHING_ROD, 65280,  Blocks.LAPIS_BLOCK, true ).setRegistryName(new ResourceLocation(MODID, "book_luckofthesea"));//lapis_block
    public static final Item SPEEDY_PHISH = new ItemEnchantableBook(Items.FISHING_ROD,"minecraft:lure",EnchantmentCategory.FISHING_ROD, 16755200,  Blocks.COMPOSTER, true ).setRegistryName(new ResourceLocation(MODID, "book_lure"));//composter
    public static final Item LOYAL_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:loyalty",EnchantmentCategory.TRIDENT, 16777215,  Items.BONE, true ).setRegistryName(new ResourceLocation(MODID, "book_loyality"));//bone
    public static final Item STABBY_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:impaling",EnchantmentCategory.TRIDENT, 16733525,  Items.BAMBOO, true ).setRegistryName(new ResourceLocation(MODID, "book_impaling"));//bamboo
    public static final Item WATERY_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:riptide",EnchantmentCategory.TRIDENT, 65535,  Blocks.PRISMARINE, true ).setRegistryName(new ResourceLocation(MODID, "book_riptide"));//prismarine
    public static final Item LIT_FORK = new ItemEnchantableBook(Items.TRIDENT,"minecraft:channeling",EnchantmentCategory.TRIDENT, 16776960,  Blocks.END_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_channeling"));//end_rod
    public static final Item MULTI_CROSS = new ItemEnchantableBook(Items.CROSSBOW,"minecraft:multishot",EnchantmentCategory.CROSSBOW, 16776960,  Items.GHAST_TEAR, true ).setRegistryName(new ResourceLocation(MODID, "book_multishot"));//ghast_tear
    public static final Item QUICK_CROSS = new ItemEnchantableBook(Items.CROSSBOW,"minecraft:quick_charge",EnchantmentCategory.CROSSBOW, 16755200,  Items.FIREWORK_STAR, true ).setRegistryName(new ResourceLocation(MODID, "book_quickcharge"));//firework_star
    public static final Item STABBY_CROSS = new ItemEnchantableBook(Items.CROSSBOW,"minecraft:piercing",EnchantmentCategory.CROSSBOW, 16733525,  Items.FIREWORK_ROCKET, true ).setRegistryName(new ResourceLocation(MODID, "book_piercing"));////firework_rocket
    public static final Item FIXERUPPER = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"minecraft:mending",EnchantmentCategory.DIGGER, 16777215,  Items.NETHER_STAR, true ).setRegistryName(new ResourceLocation(MODID, "book_mending"));//nether_star
    public static final Item BOUND_CURSE = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:binding_curse",EnchantmentCategory.ARMOR, 11141120,  Blocks.CHAIN, true ).setRegistryName(new ResourceLocation(MODID, "book_bindingcurse"));//chain
    public static final Item VANISH_CURSE = new ItemEnchantableBook(Items.DIAMOND_HELMET,"minecraft:vanishing_curse",EnchantmentCategory.ARMOR, 16711680,  Items.FERMENTED_SPIDER_EYE, true ).setRegistryName(new ResourceLocation(MODID, "book_vanishingcurse"));//fermented_spider_eye

    public static final Item APOTH_BANE = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:bane_of_illagers",EnchantmentCategory.WEAPON, 11162965,  Items.EMERALD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothbaneofillagers"));
    public static final Item APOTH_CRAZY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:berserk",EnchantmentCategory.ARMOR, 16711680,  Items.BLAZE_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothberserk"));
    public static final Item APOTH_CAPTURE = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:capturing",EnchantmentCategory.WEAPON, 11184640,  Items.EGG, true ).setRegistryName(new ResourceLocation(MODID, "book_apothcapturing"));
    public static final Item APOTH_CRESCENDO = new ItemEnchantableBook(Items.CROSSBOW,"apotheosis:crescendo",EnchantmentCategory.CROSSBOW, 11206655,  Items.ARROW, true ).setRegistryName(new ResourceLocation(MODID, "book_apothcrescendo"));
    public static final Item APOTH_MINER = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"apotheosis:depth_miner",EnchantmentCategory.DIGGER, 16755200,  Blocks.OBSIDIAN, true ).setRegistryName(new ResourceLocation(MODID, "book_apothdepthminer"));
    public static final Item APOTH_HELLINFUSION = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:hell_infusion",EnchantmentCategory.WEAPON, 16711765,  Blocks.NETHERRACK, true ).setRegistryName(new ResourceLocation(MODID, "book_apothhellinfusion"));
    public static final Item APOTH_COLDPOKEY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:icy_thorns",EnchantmentCategory.ARMOR_CHEST, 43775,  Items.SWEET_BERRIES, true ).setRegistryName(new ResourceLocation(MODID, "book_apothicythorns"));
    public static final Item APOTH_KNOWITALL = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:knowledge",EnchantmentCategory.WEAPON, 65280,  Items.EXPERIENCE_BOTTLE, true ).setRegistryName(new ResourceLocation(MODID, "book_apothknowledge"));
    public static final Item APOTH_VAMPIRE = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:life_mending",EnchantmentCategory.BREAKABLE, 11141205,  Items.WITHER_SKELETON_SKULL, true ).setRegistryName(new ResourceLocation(MODID, "book_apothlifemending"));
    public static final Item APOTH_WITCHY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:magic_protection",EnchantmentCategory.ARMOR, 11163135,  Items.POTION, true ).setRegistryName(new ResourceLocation(MODID, "book_apothmagicprotection"));
    public static final Item APOTH_DRYAD = new ItemEnchantableBook(Items.DIAMOND_HOE,"apotheosis:natures_blessing",EnchantmentCategory.DIGGER, 5635925,  Blocks.VINE, true ).setRegistryName(new ResourceLocation(MODID, "book_apothnaturesblessing"));
    public static final Item APOTH_BYEBYE = new ItemEnchantableBook(Items.ANVIL,"apotheosis:obliteration",EnchantmentCategory.BREAKABLE, 0,  Items.LAVA_BUCKET, true ).setRegistryName(new ResourceLocation(MODID, "book_apothobliteration"));
    public static final Item APOTH_BOING = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"apotheosis:rebounding",EnchantmentCategory.ARMOR, 11206485,  Items.SLIME_BALL, true ).setRegistryName(new ResourceLocation(MODID, "book_apothrebounding"));
    public static final Item APOTH_CHING = new ItemEnchantableBook(Items.SHIELD,"apotheosis:reflective",EnchantmentCategory.BREAKABLE, 16777215,  Blocks.GLASS, true ).setRegistryName(new ResourceLocation(MODID, "book_apothreflective"));
    public static final Item APOTH_SCAV = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:scavenger",EnchantmentCategory.WEAPON, 16776960,  Items.WHEAT_SEEDS, true ).setRegistryName(new ResourceLocation(MODID, "book_apothscavenger"));
    public static final Item APOTH_SEAINFUSION = new ItemEnchantableBook(Items.DIAMOND_SWORD,"apotheosis:sea_infusion",EnchantmentCategory.WEAPON, 65535,  Items.PRISMARINE_SHARD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothseainfusion"));
    public static final Item APOTH_CABAL = new ItemEnchantableBook(Items.SHIELD,"apotheosis:shield_bash",EnchantmentCategory.BREAKABLE, 11162880,  Items.SHIELD, true ).setRegistryName(new ResourceLocation(MODID, "book_apothshieldbash"));
    public static final Item APOTH_SPLITS = new ItemEnchantableBook(Items.ANVIL,"apotheosis:splitting",EnchantmentCategory.BREAKABLE, 11184810,  Blocks.ANVIL, true ).setRegistryName(new ResourceLocation(MODID, "book_apothsplitting"));
    public static final Item APOTH_FOOTY = new ItemEnchantableBook(Items.DIAMOND_BOOTS,"apotheosis:stable_footing",EnchantmentCategory.ARMOR_FEET, 5592405,  Items.GOLDEN_BOOTS, true ).setRegistryName(new ResourceLocation(MODID, "book_apothstablefooting"));
    public static final Item APOTH_SINNER = new ItemEnchantableBook(Items.DIAMOND_HOE,"apotheosis:tempting",EnchantmentCategory.DIGGER, 16755455,  Items.WHEAT, true ).setRegistryName(new ResourceLocation(MODID, "book_apothtempting"));
    public static final Item APOTH_NEVERENDING = new ItemEnchantableBook(Items.BOW,"apotheosis:true_infinity",EnchantmentCategory.BOW, 16777215,  Blocks.END_STONE, true ).setRegistryName(new ResourceLocation(MODID, "book_apothtrueinfinity"));

    public static EnchantmentCategory STRADDLEBOARD = EnchantmentCategory.create("straddleboard", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    ...
    public static final Item ARSN_BOOST = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ars_nouveau:mana_boost",EnchantmentCategory.ARMOR, 11141290,  Items.BLAZE_ROD, true ).setRegistryName(new ResourceLocation(MODID, "book_arsnmanaboost"));
    public static final Item ARSN_REGEN = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ars_nouveau:mana_regen",EnchantmentCategory.ARMOR, 11141375,  Items.GHAST_TEAR, true ).setRegistryName(new ResourceLocation(MODID, "book_arsnmanaregen"));
    public static final Item ARSN_REACTIVE = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ars_nouveau:reactive",EnchantmentCategory.WEARABLE, 11184810,  Items.GUNPOWDER, false ).setRegistryName(new ResourceLocation(MODID, "book_arsnreactive"));

    public static final Item ASTRAL_VISION = new ItemEnchantableBook(Items.DIAMOND_HELMET,"astralsorcery:night_vision",EnchantmentCategory.ARMOR_HEAD, 11141375,  Items.GOLDEN_CARROT, false ).setRegistryName(new ResourceLocation(MODID, "book_astralnightvision"));
    public static final Item ASTRAL_SCORCH = new ItemEnchantableBook(Items.DIAMOND_PICKAXE,"astralsorcery:scorching_heat",EnchantmentCategory.DIGGER, 16733440, Blocks.BLAST_FURNACE, true ).setRegistryName(new ResourceLocation(MODID, "book_astralscorchingheat"));

    public static final Item BETTERENDFORGE_VEIL = new ItemEnchantableBook(Items.DIAMOND_HELMET,"betterendforge:end_veil",EnchantmentCategory.ARMOR_HEAD, 11141290,  Blocks.CHORUS_FLOWER, true ).setRegistryName(new ResourceLocation(MODID, "book_befendveil"));

    //https://github.com/KingLemming/1.16
    //Would have to add actual code compat to do this one
    //public static final Item COFHCORE_HOLDING = new ItemEnchantableBook(Items.BOOK,"cofh_core:holding",EnchantmentCategory.VANISHABLE, 16755370,  Items.SHULKER_SHELL, true ).setRegistryName(new ResourceLocation(MODID, "book_cofhcoreholding"));

    public static EnchantmentCategory ENCHANTABLE = EnchantmentCategory.create("ENCHANTABLE", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    public static EnchantmentCategory HOE = EnchantmentCategory.create("HOE", (item -> item instanceof HoeItem));
    public static EnchantmentCategory PICKAXE_OR_SHOVEL = EnchantmentCategory.create("PICKAXE_OR_SHOVEL", (item -> item instanceof PickaxeItem || item instanceof ShovelItem));
    public static EnchantmentCategory SWORD_OR_AXE = EnchantmentCategory.create("SWORD_OR_AXE", (item -> item instanceof SwordItem || item instanceof AxeItem));
    public static EnchantmentCategory SWORD_OR_AXE_OR_CROSSBOW = EnchantmentCategory.create("SWORD_OR_AXE_OR_CROSSBOW", (item -> item instanceof SwordItem || item instanceof AxeItem || item instanceof CrossbowItem));
    public static final Item ENSORCELL_AIRAFF = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:air_affinity",EnchantmentCategory.ARMOR_HEAD, 16777215,  Items.FEATHER, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationairaffinity"));
    public static final Item ENSORCELL_ANGLER = new ItemEnchantableBook(Items.FISHING_ROD,"ensorcellation:angler",EnchantmentCategory.FISHING_ROD, 22015,  Items.TROPICAL_FISH, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationangler"));
    public static final Item ENSORCELL_BULWARK = new ItemEnchantableBook(Items.SHIELD,"ensorcellation:bulwark",EnchantmentCategory.BREAKABLE, 11162880,  Items.SHIELD, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationbulwark"));
    ...
    public static final Item ENSORCELL_CFOOL = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:curse_fool",EnchantmentCategory.ARMOR_HEAD, 11141120,  Items.GOLDEN_SWORD, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationcursefool"));
    ...
    public static final Item ENSORCELL_DISPLACE = new ItemEnchantableBook(Items.SHIELD,"ensorcellation:displacement",EnchantmentCategory.ARMOR_CHEST, 11162880,  Items.BUCKET, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationdisplacement"));
    ...
    public static final Item ENSORCELL_XPBOOST = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:exp_boost",EnchantmentCategory.ARMOR_HEAD, 65280,  Items.EXPERIENCE_BOTTLE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationexpboost"));
    public static final Item ENSORCELL_FIREREBU = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:fire_rebuke",EnchantmentCategory.ARMOR_CHEST, 16733440,  Items.FIRE_CHARGE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationfirerebuke"));
    ...
    public static final Item ENSORCELL_GOURMAND = new ItemEnchantableBook(Items.DIAMOND_HELMET,"ensorcellation:gourmand",EnchantmentCategory.ARMOR_HEAD, 16776960,  Items.RABBIT_STEW, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationgourmand"));
    public static final Item ENSORCELL_HUNTER = new ItemEnchantableBook(Items.BOW,"ensorcellation:hunter",EnchantmentCategory.BOW, 16733525,  Items.ARROW, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationhunter"));
    ...
    public static final Item ENSORCELL_MAGPROT = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:magic_protection",EnchantmentCategory.ARMOR, 11141375,  Items.GLASS_BOTTLE, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationmagicprotection"));
    public static final Item ENSORCELL_PHALANX = new ItemEnchantableBook(Items.SHIELD,"ensorcellation:phalanx",EnchantmentCategory.BREAKABLE, 11162880,  Items.WHITE_BANNER, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationphalanx"));
    public static final Item ENSORCELL_PILF = new ItemEnchantableBook(Items.FISHING_ROD,"ensorcellation:pilfering",EnchantmentCategory.FISHING_ROD, 16776960,  Items.DIAMOND, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationpilfering"));
    public static final Item ENSORCELL_QUICKD = new ItemEnchantableBook(Items.BOW,"ensorcellation:quick_draw",EnchantmentCategory.BOW, 16755200,  Items.BOW, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationquickdraw"));
    public static final Item ENSORCELL_REACH = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:reach",EnchantmentCategory.ARMOR_CHEST, 11206485,  Blocks.PISTON, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationreach"));
    ...
    public static final Item ENSORCELL_TRUESHOT = new ItemEnchantableBook(Items.BOW,"ensorcellation:trueshot",EnchantmentCategory.BOW, 16755370,  Blocks.TARGET, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationtrueshot"));
    public static final Item ENSORCELL_VITALITY = new ItemEnchantableBook(Items.DIAMOND_CHESTPLATE,"ensorcellation:vitality",EnchantmentCategory.ARMOR_CHEST, 16711765,  Items.POTION, true ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationvitality"));
    public static final Item ENSORCELL_VOLLEY = new ItemEnchantableBook(Items.BOW,"ensorcellation:volley",EnchantmentCategory.BOW, 16755370,  Items.CROSSBOW, false ).setRegistryName(new ResourceLocation(MODID, "book_ensorcellationvolley"));
    ...
    public static EnchantmentCategory KNIFE = EnchantmentCategory.create("knife", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    ...
    public static EnchantmentCategory GWR_GUN = EnchantmentCategory.create("GWR_GUN", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    ...
    public static final Item MVL_REPAIR = new ItemEnchantableBook(Items.BOW,"morevanillalib:repairing_luck",EnchantmentCategory.BREAKABLE, 16777215,  Items.RABBIT_FOOT, true ).setRegistryName(new ResourceLocation(MODID, "book_mvlrepairingluck"));

    public static EnchantmentCategory HAMMA = EnchantmentCategory.create("mythicbotany_mjoellnir", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    ...
    public static final Item NATURES_MEND = new ItemEnchantableBook(Items.BOW,"naturesaura:aura_mending",EnchantmentCategory.BREAKABLE, 5635925,  Blocks.OAK_LEAVES, true ).setRegistryName(new ResourceLocation(MODID, "book_naturesauramending"));

    public static EnchantmentCategory TARANGE = EnchantmentCategory.create("travel_anchors_teleportable", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
    public static EnchantmentCategory TATELE = EnchantmentCategory.create("travel_anchors_teleportable_no_staff", (item -> item.getItemEnchantability(new ItemStack(item)) > 0));
